...
export default function Create({
    ...
    const [workflowData, setWorkflowData] = useState({
        ...
        generated_messages: workflow.generated_messages
    });
    ...
    const addStep = () => {
        ...
        if (newStepData.stepName.trim() !== "" && newStepData.content.trim() !== "") {
            // Include selectedFileIds if present
            const newStep = {
                ...newStepData,
                id: stepsState.length + 1,
                ...(Array.isArray(newStepData.selectedFileIds) ? { selectedFileIds: newStepData.selectedFileIds } : {})
            };
