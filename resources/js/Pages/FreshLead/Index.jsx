            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="overflow-x-auto mx-auto my-4 w-full max-w-8xl p-6 bg-white rounded-lg shadow-md">
                    ...
                    <table className="min-w-full border-collapse border border-gray-200">
                        ...
                        <tbody>
                            {freshLeads.length > 0 ? (
                                freshLeads.map((freshlead, index) => (
                                    <tr key={freshlead.id} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                                        <td className="border border-gray-300 px-4 py-2">{index + 1}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.phone}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.contact_name}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.workflow_id}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.organisation_id}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.user_id}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.zipcode}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.state}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.city}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.address}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.offer}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.email}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.age}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.gender}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.lead_score}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.agent}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.novation}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.creative_price}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.monthly}</td>
                                        <td className="border border-gray-300 px-4 py-2">{freshlead.downpayment}</td>
                                        <td className="border border-gray-300 px-4 py-2">
                                            <button
                                                onClick={() => handleShowMessages(freshlead.messages)}
